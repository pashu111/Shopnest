...
// Flatten Redux products into a searchable array
const flattenProducts = (reduxItems) =>
  (reduxItems || []).filter(p => p.isPublic !== false).map(p => ({
    ...p,
...
export default function AIAssistant() {
  ...
  const reduxItems = useSelector((state) => state.products.items);
  
  const allProducts = useMemo(() => flattenProducts(reduxItems), [reduxItems]);
